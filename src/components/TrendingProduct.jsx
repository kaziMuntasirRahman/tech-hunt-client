...
const Cart = ({ product }) => {
  const { name, description, upvotes, reviews } = product;
  return (
    <div className="bg-white hover:bg-gray-50 rounded-2xl flex flex-col gap-1.5 py-4 px-2.5 transition-all duration-200 ease-in-out">
      <div className="flex items-center gap-2.5">
        ...
        <p className="text-sm text-gray-500 cursor-pointer hover:text-[#FF6154] font-medium transition-colors duration-300">/{name}</p>
      </div>
